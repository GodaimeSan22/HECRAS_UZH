...
var googleSatellite = L.tileLayer("https://mt1.google.com/vt/lyrs=s&x={x}&y={y}&z={z}", {
  maxZoom: 20,
  attribution: 'Tiles courtesy of <a href="http://www.google.com" target="_blank">Google</a>'
});
var googleHybrid = L.layerGroup([
  ...
  L.tileLayer("https://mt1.google.com/vt/lyrs=y&x={x}&y={y}&z={z}", {
    maxZoom: 19,
    attribution: 'Labels courtesy of <a href="http://www.google.com" target="_blank">Google</a>'
  })
])
